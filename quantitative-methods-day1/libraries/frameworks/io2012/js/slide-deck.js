...
SlideDeck.prototype.loadConfig_ = function(config) {
  ...
  if (!!!('enableSlideAreas' in settings) || settings.enableSlideAreas) {
	...
	var  arrLeftHTML = "<img id='aPrevImg' style='width:50px; display:none; margin-top:320px; margin-right:30px; float:right;' src = 'assets\\img\\arrow_left.png' />" 
	document.getElementById('prev-slide-area').innerHTML = arrLeftHTML;
	...
	var  arrLeftHTML = "<img id='aNextImg' style='width:50px; display:none; margin-top:320px; margin-left:30px; float:left;' src = 'assets\\img\\arrow_right.png' />" 
	document.getElementById('next-slide-area').innerHTML = arrLeftHTML;
  }

  // check and display arrows
  this.showArrows();
...
// Added by Lahiru on  2013-09-16
SlideDeck.prototype.showArrows = function() {
	if (this.curSlide_ >0) {
		document.getElementById('aPrevImg').style.display = 'block';
	}else{
		document.getElementById('aPrevImg').style.display = 'none';
	}
	
	if (this.curSlide_ < this.slides.length - 1) {
		document.getElementById('aNextImg').style.display = 'block';
	}else{
		document.getElementById('aNextImg').style.display = 'none';
	}
}
